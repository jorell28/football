...
game.onUpdateInterval(5000, function() {
    enemy.follow(mySprite, 55, 55)
    enemy2.follow(mySprite, 65, 65)
    enemy3.follow(mySprite, 80, 80)
    enemy4.follow(mySprite, 65, 65)
    enemy5.follow(mySprite, 55, 55)
    enemy6.follow(mySprite, 90, 90)
    enemy7.follow(mySprite, 35, 35)
    enemy8.follow(mySprite, 35, 35)
})
